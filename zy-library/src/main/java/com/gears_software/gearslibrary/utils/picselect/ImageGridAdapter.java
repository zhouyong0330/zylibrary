...
import com.gears_software.gearslibrary.utils.picselect.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((Bimp.drr.size() + selectTotal) < PicUtils.count) {
				...
				} else if ((Bimp.drr.size() + selectTotal) >= PicUtils.count) {
